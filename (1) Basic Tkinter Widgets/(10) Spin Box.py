...
# Label 5
label5 = Label(root,text='Birth-Day Year : ',pady=5)
...
def Display():
    ...
    print('Birth-Day Year :',spin_var.get())
...
# Declaring a variable for spin box
spin_var = StringVar()

# Creating a spin box
spin_box = Spinbox(root,textvariable=spin_var,from_=1990,to=2090,state='readonly')
...
spin_box.grid(row=4,column=1,sticky=W)
label2.grid(row=5,column=0,sticky=W)
entry2.grid(row=5,column=1)
check_button.grid(row=6,column=1,sticky=W)
